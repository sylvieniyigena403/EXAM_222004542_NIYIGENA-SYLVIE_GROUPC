 ...
 * @author user1
 */
public class sylvie extends javax.swing.JFrame {

    /**
     * Creates new form sylvie
     */
    public sylvie() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
          ...
          String name=jTextField2.getText();
            ...
            PreparedStatement ps=con.prepareStatement("update sylvie set name=?,age=?,gender=? where id=?");
 ps.setString(1, name);
 ps.setString (2, age);
 ...
 JOptionPane.showMessageDialog(this, "good");
            ...
            Logger.getLogger(sylvie.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/school","root","");
            PreparedStatement ps=con.prepareStatement("insert into sylvie (name,age,gender)values(?,?,?)");
 ps.setString(1, name);
 ps.setString(2, age);
 if(jRadioButton1.isSelected()){
     ps.setString(3, jRadioButton1.getText());
     ...
     ps.setString(3, jRadioButton2.getText());
 ps.executeUpdate();
 JOptionPane.showMessageDialog(this, "the name added in our table");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/school","root","");
            PreparedStatement ps=con.prepareStatement("delete from sylvie where id=?");
 ps.setString(1, id);
 ps.executeUpdate();
 JOptionPane.showMessageDialog(this, "information deleted");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sylvie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
